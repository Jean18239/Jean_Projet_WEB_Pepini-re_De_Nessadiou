...
$pageUrl = route_url('catalogue.fruitiers');
...
if (!$dbDisponible) {
    ...
    $sql = "SELECT * FROM produits WHERE type = 'fruitier'";
    ...
    if ($result && $result->num_rows > 0) {
        ...
        echo "<p class='catalogue-message'>Aucun fruitier disponible</p>";
    }
}
?>
